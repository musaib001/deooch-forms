...
## Corpus Check
- 107 files · ~167,846 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 454 nodes · 836 edges · 26 communities (18 shown, 8 thin omitted)
...
Cohesion: 0.09
Nodes (16): ConnectPage(), ERRORS, FAQS, metadata, TOOLS, FEATURES, Home(), STEPS (+8 more)
